...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        restaurants = [
            ...
            {'name': 'Bangladeshi 1', 'date_opened': timezone.now() - timezone.timedelta(days=44), 'restaurant_type': Restaurant.TypeChoices.BANGLADESHI, 'latitude': 51.509865, 'longitude':  -0.118092},
            ...
            {'name': 'Bangladeshi 2', 'date_opened': timezone.now() - timezone.timedelta(days=46), 'restaurant_type': Restaurant.TypeChoices.BANGLADESHI, 'latitude': 53.350140, 'longitude':  -6.266155},
